    ...
    return (
        <>
            ...
            >
                ...
                {cartState.items.map((item, idx) => <CartItem quantity={item.quantity} key={item.product.id} product={item.product} handleDeleteProduct={handleRemoveProduct}/>)}
                <Box className="subtotal">
                    <Typography variant="subtitle2">SUBTOTAL</Typography>
                    <Typography variant="subtitle2">${cartState.totalPrice}</Typography>
                </Box>
